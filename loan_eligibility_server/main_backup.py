...
def get_smart_step_size(amount: float) -> float:
    """Calculate smart step size for loan amount iteration based on amount size"""
    if amount < 10000:
        return 500
    elif amount < 50000:
        return 1000
...
def update_score_status(
    ...
    if assessment.scorerId != current_user.id:
        raise HTTPException(
